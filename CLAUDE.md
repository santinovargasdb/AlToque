...
**Steps 1–8 completos** (typecheck/lint/test/build OK).
...
Pendiente (seguir el **Build Order**, Sección 9): pagos MP (Step 9) → reviews (Step 10) → chat (Step 11) → admin completo (Step 12) → SEO (Step 13) → polish + deploy (Step 14).
